...
U16 CRC8_CCITT_U16(const U16 * const data_pU16, const U16 n_bytes_U16)
{
    U16 temp_U16 = (U16)0;
    U16 idx_iU16;
    for(idx_iU16 = (U16)0; idx_iU16 < n_bytes_U16; idx_iU16++)
    {
        temp_U16 = CRC8_CCITT_LUT_U16[temp_U16 ^ data_pU16[idx_iU16]];
    }
    return temp_U16;
}
...
boolean CRC8_CCITT_Verify_b(const U16 * const data_pU16, const U16 n_bytes_U16, const U16 expected_crc_U16)
{
    ...
    if( CRC8_CCITT_U16(data_pU16, n_bytes_U16) != expected_crc_U16 )
    {
        res_b = False_b;
    }
    return res_b;
