...
#define MAX_SPEED__rad_s__df32                             ( (F32)1.0f )
...
/*MOTOR CONSTANT*/
#define MOTOTR_MOMENT_OF_INERTIA__kg_m2__df32              ( (F32)1.0f )
#define MOTOR_TORQUE_CONSTANT__Nm_A__df32                  ( (F32)1.0f ) // kt
#define MOTOR_INDUCTANCE__H__df32                          ( (F32)1.0f )
/* lambda = kt/(1.5*p) */
#define MOTOR_MAGNETIC_FLUX_OF_ROTOR_MAGNTES__Wb__df32     (F32)( (MOTOR_TORQUE_CONSTANT__Nm_A__df32) / ( ( 3.0/2.0 ) * (F32)MOTOR_POLE_PAIRS_dU16 ) )
